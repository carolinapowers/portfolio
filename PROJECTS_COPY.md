# Portfolio Projects - Copy Review

This document contains all project descriptions from the portfolio for copywriting review and refinement.

---

## 1. Structure TypeScript Applications with Barrel Files and Module Re-exports Code Lab

**Category:** Learning Experiences
**Featured:** Yes
**Live Demo:** [Pluralsight Code Lab](https://app.pluralsight.com/code-labs/contents/03dc3a20-f895-432d-8fc5-f9bb1f66a224/learn)
...
## 2. Model Context Protocol (MCP) Server for Code Lab Generation

**Category:** AI & Emerging Tech
**Featured:** Yes
**GitHub:** [code-lab-mcp-server](https://github.com/carolinapowers/code-lab-mcp-server)
...
## 3. PickleBrasil - Pickleball Community Platform

**Category:** AI & Emerging Tech
**Featured:** Yes
**Live Demo:** [picklebrasil.vercel.app](https://picklebrasil.vercel.app/)
...
## 4. Bolt Rapid Prototyping Portfolio

**Category:** AI & Emerging Tech
**Featured:** Yes
**Projects:**

- **CodeCraft Academy AI** - [GitHub](https://github.com/carolinapowers/code-craft) | [Live Demo](https://codecraft-academy-ai-duff.bolt.host/)
- **QuestAied** - [GitHub](https://github.com/carolinapowers/QuestAied) | [Live Demo](https://questaied-app-duplic-5upw.bolt.host/)
...
## 5. Interactive Portfolio - Agentic Development Showcase

**Category:** AI & Emerging Tech
**Featured:** Yes
**GitHub:** [portfolio](https://github.com/carolinapowers/portfolio)
...
## 6. React Testing Hands-on Code Lab

**Category:** Learning Experiences
**Featured:** Yes
**Live Demo:** [Pluralsight Code Lab](https://app.pluralsight.com/code-labs/contents/62a6025c-17b3-4d79-a28b-7ac116e8f038/learn)
...
## 7. Vue.js Guided Project: Reading List Application with Forms

**Category:** Learning Experiences
**Featured:** Yes
**Live Demo:** [Pluralsight Code Lab](https://app.pluralsight.com/code-labs/contents/a39a4529-3ae5-4b45-a086-80a456350717/learn)
...
## 8. Vue TDD Automation - npm Package for Testing Workflows

**Category:** Developer Experience
**Featured:** Yes
**GitHub:** [vue-tdd-automation](https://github.com/carolinapowers/vue-tdd-automation)
...
## 9. Custom ESLint Rules (AST Parsing) at Articulate
...
## 10. Testing Infrastructure Modernization at Articulate
...
- **Story Section**: Short, engaging summary (2-3 sentences) that highlights key achievements and technologies
- **Project Details**: Comprehensive technical narrative (3-4 paragraphs) with specific implementation details and outcomes
- **Tone**: Professional but approachable, demonstrating technical expertise while remaining accessible
- **Focus**: Emphasize impact, problem-solving, and technical innovation

### Questions to Consider:

1. Does each story clearly communicate the project's value and uniqueness?
2. Are the project details comprehensive enough without being overwhelming?
3. Is the technical depth appropriate for a mixed audience (technical recruiters and engineering managers)?
4. Do the descriptions showcase both technical skills and strategic thinking?
5. Are there any jargon terms that need clarification or simplification?
