...
Carolina was always eager to lend a hand—whether pairing on a tricky bug, reviewing a pull request, or offering thoughtful support in Slack. Her collaborative spirit, technical acumen, and empathy made her a standout teammate, and any team would be incredibly fortunate to work with her.`,
  ...
  },
  {
    ...
    skills: ['React', 'Node.js', 'SQL', 'Testing', 'Vibrant Energy', 'Fun', 'Testing Excellence', 'Code Quality', 'Team Collaboration', 'Collaborative Spirit'],
    date: 'July 1, 2025',
  ...
  },
  {
    ...
    skills: ['Design Collaboration', 'Ownership', 'Engineering Quality', 'Mentorship', 'Leadership', 'Partner Collaboration'],
    date: 'June 28, 2025',
  ...
  },
  {
    ...
    skills: ['Leadership', 'Customer Focus', 'Team Support', 'Initiative', 'Team Collaboration'],
    date: 'May 27, 2025',
  ...
  },
  {
    ...
    skills: ['JavaScript', 'AngularJS', 'Quick Learning', 'Team Contribution', 'Team Collaboration'],
    date: 'June 8, 2016',
