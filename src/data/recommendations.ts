...
export const recommendations: readonly Recommendation[] = [
  ...
  },
  {
    ...
    company: "CodeSandbox",
    avatar: "AF",
    summary: "Solved complex problems in new languages every month with technical depth and adaptability.",
    content: "Carolina and I joined Code School (later Pluralsight) around the same time, working together on one of the strangest and most dynamic teams there is. She tackled difficult software engineering problems with highly technical solutions — all in a new and different programming language nearly every month, based on the topic of instruction. She excelled at both this project-driven structure as well as the product-driven roles we eventually transitioned to during our tenure together. Trust her to deliver the right thing, done right, with experience in a variety of programming languages, runtimes, and paradigms.",
    skills: ["Programming Paradigms", "Languages", "Adaptability", "Problem Solving"],
    date: "July 1, 2025",
  ...
  },
  {
    ...
    company: "Dropbox",
    avatar: "MO",
    summary: "Brilliant engineer and generous mentor who consistently delivers high-quality work.",
    content: "Carolina is a brilliant software engineer who takes immense pride in her work and consistently delivers. She's also a fantastic mentor who has taught me a tremendous amount. I wholeheartedly recommend her.",
    skills: ["Mentorship", "Software Engineering", "Consistency", "Quality Delivery"],
    date: "June 30, 2025",
  ...
  },
  {
    ...
    company: "Pluralsight",
    avatar: "KL",
    summary: "Great mentor with high integrity and strong web development skills.",
    content: "Carolina is a stellar person to work with. She is skilled as an engineer and has all the hallmarks of a great teammate; she has a high degree of personal integrity, offers thoughtful insights, asks the right questions, and is skilled at web software development. Carolina would often proactively seek ways to help me learn when I was new on the team and I consider her a great mentor because of it. She makes the engineers on her team better by the way she works and communicates. She has my strongest endorsement and recommendation.",
    skills: ["Mentorship", "Web Development", "Integrity", "Team Communication"],
    date: "June 28, 2025",
  ...
  },
  {
    ...
    company: 'BILL',
    avatar: 'MB',
    summary: "Creative and dedicated engineer who proactively drives innovation and user-centered solutions.",
    ...
    skills: ['Creative Problem-Solving', 'User Research', 'Engineering Innovation', 'Team Collaboration'],
    date: 'June 6, 2025',
  ...
  },
  {
    ...
    company: 'Pluralsight',
    avatar: 'JL',
    summary: "Thoughtful leader who advocates for customers and helps teams explore meaningful solutions.",
  ...
  },
  {
    ...
    avatar: 'MH',
    summary: "Supportive mentor who empowered students through technical guidance and dedication.",
    ...
    skills: ['Mentorship', 'Technical Guidance', 'Education', 'Student Success'],
    date: 'June 30, 2016',
  ...
  },
  {
    ...
    avatar: 'MM',
    summary: "Passionate and fast-learning developer who became a go-to expert in JavaScript and AngularJS.",
...
export type PortfolioRecommendationType = typeof portfolioRecommendations[number];